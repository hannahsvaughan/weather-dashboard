var APIKey = "25ee199cf6b912ff000a1bab44ef907b";
var cities = [];
cities.reverse();
...
// get API data with Ajax
    $.ajax({ url: queryURL, type: "GET"}).then(function(response) {
        ...
        var iconSrc = "https://openweathermap.org/img/w/" + iconLoc + ".png";
        var iconImage = $("<img>");
...
function forecast(city) {
    ...
    $.ajax({ url: forecastURL, type: "GET"}).then(function (response) {
        ...
        for (var i = 39; i >= 0; i = i - 8) {
            ...
            var iconID = list[i].waether[0].icon;
